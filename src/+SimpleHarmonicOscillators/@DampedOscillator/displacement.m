function [x, t] = displacement(sho, t_end, opt)
    arguments
    ...
    if isequal(damping_type, "underdamping")
        [x, t] = sho.displacement_for_underdamping_case(t_end, ...
    ...
    elseif isequal(damping_type, "overdamping")
        [x, t] = sho.displacement_for_overdamping_case(t_end, ...
            TimeResolution = opt.TimeResolution, ...
            InitialPosition = opt.InitialPosition, ...
            InitialVelocity = opt.InitialVelocity);
    else
        [x, t] = sho.displacement_for_critical_damping_case(t_end, ...
            TimeResolution = opt.TimeResolution, ...
            InitialPosition = opt.InitialPosition, ...
            InitialVelocity = opt.InitialVelocity);
    end
